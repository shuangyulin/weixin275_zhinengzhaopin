  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">微信智能招聘小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.gongsidianhua" class="input" type="text" placeholder="公司电话">
			   </div>
			 </div> -->
			<el-form-item label="公司电话" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.gongsidianhua" autocomplete="off" placeholder="公司电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qiye'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`yonghu` == this.tableName && this.ruleForm.clicknum&&(!this.$validate.isIntNumer(this.ruleForm.clicknum))){
      ...
      if(`qiye` == this.tableName && this.ruleForm.gongsidianhua&&(!this.$validate.isPhone(this.ruleForm.gongsidianhua))){
